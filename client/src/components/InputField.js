    ...
    return (
        <div className="container flex flex-col h-screen mx-auto">
            <div className="m-auto">
                <div className="md:shadow p-10 md:border-2 border-opacity-50">
                ...
                <div className={"md:shadow mt-4 p-10 md:border-2 border-opacity-50 " + ((validate.everything_valid) ? "bg-green-50" : "bg-red-50")}>
